<template>
  <div>
    <el-card class="box-card">
      <el-row>
        <el-col :span="12">
          <div class="leftDiv" v-if="fileList.length==0">
            <div class="innerDiv">
              <div class="plsIcon">
              ...
              <input type="file" id="file" hidden @change="fileChange" multiple>
              　
              <el-button type="primary" @click="btnChange">Chose File</el-button>
          ...
          <div v-if="fileList.length>0">
            <div class="hiddMainCls">
              <div class="uploadHiddenCls">
                <div class="cardList">
                  <el-card class="listItemcls" v-for="(item,i) in fileList">
                    <!--                    <div style="margin-left: 5px;padding: 10px">-->
                    <!--                      <div style="display:inline">-->
                    <!--                        <span class="fa fa-file-text" style="color: #3a8ee6;font-size: 35px"></span>-->
                    <!--                      </div>-->
                    ...
                    <el-row>
                      ...
                      <el-col :span="2" offset="11" style="margin-top: 10px">
                        <el-button type="text" icon="el-icon-close" style="font-size: 30px;color: gray"></el-button>
                ...
                <div class="countRow">
                  <el-row>
                    <el-col :span="6">
                      <el-button type="primary" icon="el-icon-circle-plus-outline">select files to upload</el-button>
                    </el-col>
              ...
              <div class="passwordCls">
                <el-checkbox v-model="passwordChecked" border size="medium" style="display: inline-block">Password
                  protection
                </el-checkbox>
                <el-input v-if="passwordChecked==true" v-model="passwordInput" placeholder="Please input a password"
                          style="width: auto"></el-input>

              </div>
              <div class="realUploadButtonDiv">
                <el-button type="primary" class="realUploadButtonCls">Upload</el-button>
